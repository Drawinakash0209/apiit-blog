...
<div x-data="{ open: false, activeLink: localStorage.getItem('activeLink') || 'home' }" class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
            ...
            <a @click="setActiveLink('feedback')" :class="{ 'bg-gray-200': activeLink === 'feedback' }" class="px-4 py-2 mt-2 text-sm  rounded-lg dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/feedback/show">Feedbacking</a>
            <a @click="setActiveLink('life')" :class="{ 'bg-gray-200': activeLink === 'life' }" class="px-4 py-2 mt-2 text-sm rounded-lg dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/jobs/show">Career Portal</a>
