...
<header class="bg-white shadow-lg h-24 hidden md:flex mt-4 pb-4">
    ...
    <nav class="header-links contents font-semibold text-base lg:text-lg">
        <ul class="flex items-center ml-4 xl:ml-8 mr-auto">
            <li class="p-3 xl:p-6 active customnavlink">
                <a href="">
                    <span>Home</span>
                </a>
            </li>
            <li class="p-3 xl:p-6 customnavlink">
                <a href="">
                    <span>Services</span>
                </a>
            </li>
            ...
            <li class="p-3 xl:p-60 customnavlink">
                <a href="">
                    <span>Contacts</span>
                </a>
            </li>
    ...
    <div class="border flex items-center px-4 lg:px-6 xl:px-8">
        <button class="bg-black hover:bg-gray-400 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded">Contact Me</button>
    </div>
</header> --}}
<main class=" mt-24">
...
{{--                 
                ...
                <a href="student/login" class="flex text-gray-600 cursor-pointer transition-colors duration-300 font-semibold text-blue-600">
                    <svg class="fill-current h-5 w-5 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M10,17V14H3V10H10V7L15,12L10,17M10,2H19A2,2 0 0,1 21,4V20A2,2 0 0,1 19,22H10A2,2 0 0,1 8,20V18H10V20H19V4H10V6H8V4A2,2 0 0,1 10,2Z" />
                    </svg>
                    Login
