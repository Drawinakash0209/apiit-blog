    ...
    <div class="header-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <a href="user/garden-index.html"><img src="user/images/version/garden-logo.png" alt=""></a>
                    </div><!-- end logo -->
                </div>
            </div><!-- end row -->
        </div><!-- end header-logo -->
        ...
        <div class="container">
            <nav class="navbar navbar-inverse navbar-toggleable-md">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-index.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-category.html">Gardening</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-category.html">Outdoor Living</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-category.html">Indoor Living</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-category.html">Shopping Guides</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="user/garden-contact.html">Contact</a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="page-wrapper">
                        <div class="blog-list clearfix">
                            ...
                            <div class="blog-box row">
                                ...
                                <div class="blog-meta big-meta col-md-8">
                                    <span class="bg-aqua"><a href="user/garden-category.html" title="">Indoor</a></span>
                                    <h4><a href="user/garden-single.html" title="">How do you like the idea of creating a garden from the Amazon forests?</a></h4>
                                    <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh, maximus ac felis nec, maximus tempor odio.</p>
                                    <small><a href="user/garden-category.html" title=""><i class="fa fa-eye"></i> 4441</a></small>
                                    <small><a href="user/garden-single.html" title="">10 July, 2017</a></small>
                                    <small><a href="#" title="">by Matilda</a></small>
                                </div><!-- end meta -->
                            </div><!-- end blog-box -->
